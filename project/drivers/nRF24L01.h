...
// SSI port
#define RF_SSI_BASE            SSI2_BASE
#define RF_SSI_SYSCTL_PERIPH   SYSCTL_PERIPH_SSI2

// GPIO for SSI pins
#define RF_GPIO_PORT_BASE      GPIO_PORTB_BASE
#define RF_GPIO_SYSCTL_PERIPH  SYSCTL_PERIPH_GPIOB
#define RF_SSI_CLK             GPIO_PIN_4
#define RF_SSI_TX              GPIO_PIN_7
#define RF_SSI_RX              GPIO_PIN_6
#define RF_SSI_FSS             GPIO_PIN_5
#define RF_SSI_PINS            (RF_SSI_TX | RF_SSI_RX | RF_SSI_CLK )

//CSN port
#define RF_CSN_BASE GPIO_PORTB_BASE
#define RF_CSN_SYSCTL_PERIPH SYSCTL_PERIPH_GPIOB
#define RF_CSN_PORT GPIO_PIN_5

//CE port
#define RF_CE_BASE GPIO_PORTB_BASE
#define RF_CE_SYSCTL_PERIPH SYSCTL_PERIPH_GPIOB
#define RF_CE_PORT GPIO_PIN_3

//IQR port
#define RF_IQR_BASE GPIO_PORTB_BASE
#define RF_IQR_SYSCTL_PERIPH SYSCTL_PERIPH_GPIOB
#define RF_IQR_PORT GPIO_PIN_2


//==============================RF24L01_CSN======================================
#define  RF24L01_CSN_0        ROM_GPIOPinWrite(RF_CSN_BASE, RF_CSN_PORT, 0)         
#define  RF24L01_CSN_1        ROM_GPIOPinWrite(RF_CSN_BASE, RF_CSN_PORT, RF_CSN_PORT)        
//=============================RF24L01_CE======================================
#define  RF24L01_CE_0       ROM_GPIOPinWrite(RF_CE_BASE, RF_CE_PORT, 0)       
#define  RF24L01_CE_1       ROM_GPIOPinWrite(RF_CE_BASE, RF_CE_PORT, RF_CE_PORT)     
//=============================RF24L01_SCK======================================
