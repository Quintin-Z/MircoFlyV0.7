...
int32_t Moto_PWM_1=0,Moto_PWM_2=0,Moto_PWM_3=0,Moto_PWM_4=0,Moto_PWM_5=0,Moto_PWM_6=0,Moto_PWM_7=0,Moto_PWM_8=0;

void Control(T_float_angle *att_in,T_int16_xyz *gyr_in, T_RC_Data *rc_in, rt_uint8_t armed)
{
	T_float_angle angle;
	...
	//rt_kprintf("pwm1=%d,pwm2=%d,pwm3=%d,pwm4=%d\n",Moto_PWM_1,Moto_PWM_2,Moto_PWM_3,Moto_PWM_4);
